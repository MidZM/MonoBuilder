...
namespace MonoBuilder.Models
{
    ...
    public class ConversionRule : BaseViewModel, IDataErrorInfo
    {
		...
		public string PatternString
		{
			...
			set
			{
				...
				try
				{
					var newRegex = new Regex(_patternString);
					_pattern = newRegex;
		...
		public bool PatternMismatch { get; private set; } = false;
		...
		public string this[string columnName]
		{
			get
			{
				if (columnName == nameof(PatternString))
				{
		...
		public string Error => this[nameof(PatternString)];
    }
